...
export const OfflineIndicator: React.FC = () => {
    const { isOnline, isOfflineForced, pendingChangesCount, lastSyncTime, isSynchronizing, clearPendingChanges } = useOffline(); // Manque synchronize
        ...
        >
            <div className="flex items-center gap-2">
                ...
                {isOnline && !isOfflineForced && (
                    <button
                        onClick={() => {} /* Trigger synchronization */}
